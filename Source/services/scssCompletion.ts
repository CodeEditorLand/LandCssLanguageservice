...
export class SCSSCompletion extends CSSCompletion {
	...
	private static colorProposals: IFunctionInfo[] = [
		{
			func: "red($color)",
			desc: l10n.t("Gets the red component of a color."),
		},
		{
			func: "green($color)",
			desc: l10n.t("Gets the green component of a color."),
		},
		{
			func: "blue($color)",
			desc: l10n.t("Gets the blue component of a color."),
		},
		{
			func: "mix($color, $color, [$weight])",
			desc: l10n.t("Mixes two colors together."),
		},
		{
			func: "hue($color)",
			desc: l10n.t("Gets the hue component of a color."),
		},
		{
			func: "saturation($color)",
			desc: l10n.t("Gets the saturation component of a color."),
		},
		{
			func: "lightness($color)",
			desc: l10n.t("Gets the lightness component of a color."),
		},
		{
			func: "adjust-hue($color, $degrees)",
			desc: l10n.t("Changes the hue of a color."),
		},
		{
			func: "lighten($color, $amount)",
			desc: l10n.t("Makes a color lighter."),
		},
		{
			func: "darken($color, $amount)",
			desc: l10n.t("Makes a color darker."),
		},
		{
			func: "saturate($color, $amount)",
			desc: l10n.t("Makes a color more saturated."),
		},
		{
			func: "desaturate($color, $amount)",
			desc: l10n.t("Makes a color less saturated."),
		},
		{
			func: "grayscale($color)",
			desc: l10n.t("Converts a color to grayscale."),
		},
		{
			func: "complement($color)",
			desc: l10n.t("Returns the complement of a color."),
		},
		{
			func: "invert($color)",
			desc: l10n.t("Returns the inverse of a color."),
		},
		{
			func: "alpha($color)",
			desc: l10n.t("Gets the opacity component of a color."),
		},
		{
			func: "opacity($color)",
		...
		},
		{
			...
			desc: l10n.t("Changes the alpha component for a color."),
		},
		{
			func: "opacify($color, $amount)",
			desc: l10n.t("Makes a color more opaque."),
		},
		{
		...
		},
		{
			...
			desc: l10n.t("Makes a color more transparent."),
		},
		{
		...
		},
		{
			...
			desc: l10n.t("Fluidly scales one or more properties of a color."),
		},
		{
			func: "change-color($color, [$red], [$green], [$blue], [$hue], [$saturation], [$lightness], [$alpha])",
			desc: l10n.t("Changes one or more properties of a color."),
		},
		{
	...
	private static selectorFuncs: IFunctionInfo[] = [
		...
		},
		{
			...
			desc: l10n.t("Extends $extendee with $extender within $selector."),
		},
		{
		...
		},
		{
			...
			desc: l10n.t("Parses a selector into the format returned by &."),
		},
	];
	...
	private static builtInFuncs: IFunctionInfo[] = [
		{
			func: "unquote($string)",
			desc: l10n.t("Removes quotes from a string."),
		},
		{ func: "quote($string)", desc: l10n.t("Adds quotes to a string.") },
		{
			func: "str-length($string)",
			desc: l10n.t("Returns the number of characters in a string."),
		},
		{
			func: "str-insert($string, $insert, $index)",
			desc: l10n.t("Inserts $insert into $string at $index."),
		},
		{
		...
		},
		{
			...
			desc: l10n.t("Extracts a substring from $string."),
		},
		{
			func: "to-upper-case($string)",
			desc: l10n.t("Converts a string to upper case."),
		},
		{
			func: "to-lower-case($string)",
			desc: l10n.t("Converts a string to lower case."),
		},
		{
			func: "percentage($number)",
			desc: l10n.t("Converts a unitless number to a percentage."),
			type: "percentage",
		},
		{
			func: "round($number)",
			desc: l10n.t("Rounds a number to the nearest whole number."),
		},
		{
			func: "ceil($number)",
			desc: l10n.t("Rounds a number up to the next whole number."),
		},
		{
			func: "floor($number)",
			desc: l10n.t("Rounds a number down to the previous whole number."),
		},
		{
			func: "abs($number)",
			desc: l10n.t("Returns the absolute value of a number."),
		},
		{
			func: "min($numbers)",
			desc: l10n.t("Finds the minimum of several numbers."),
		},
		{
			func: "max($numbers)",
			desc: l10n.t("Finds the maximum of several numbers."),
		},
		{ func: "random([$limit])", desc: l10n.t("Returns a random number.") },
		{
			func: "length($list)",
			desc: l10n.t("Returns the length of a list."),
		},
		{
			func: "nth($list, $n)",
			desc: l10n.t("Returns a specific item in a list."),
		},
		{
			func: "set-nth($list, $n, $value)",
			desc: l10n.t("Replaces the nth item in a list."),
		},
		{
			func: "join($list1, $list2, [$separator])",
			desc: l10n.t("Joins together two lists into one."),
		},
		{
			func: "append($list1, $val, [$separator])",
			desc: l10n.t("Appends a single value onto the end of a list."),
		},
		{
			func: "zip($lists)",
			desc: l10n.t(
		...
		},
		{
			...
			desc: l10n.t("Returns the position of a value within a list."),
		},
		{
			func: "list-separator(#list)",
			desc: l10n.t("Returns the separator of a list."),
		},
		{
		...
		},
		{
			...
			desc: l10n.t("Merges two maps together into a new map."),
		},
		{
			func: "map-remove($map, $keys)",
			desc: l10n.t("Returns a new map with keys removed."),
		},
		{
			func: "map-keys($map)",
			desc: l10n.t("Returns a list of all keys in a map."),
		},
		{
			func: "map-values($map)",
			desc: l10n.t("Returns a list of all values in a map."),
		},
		{
		...
		},
		{
			...
			desc: l10n.t("Returns whether a mixin with the given name exists."),
		},
		{
			func: "inspect($value)",
			desc: l10n.t(
		...
		{
			func: "type-of($value)",
			desc: l10n.t("Returns the type of a value."),
		},
		{
			func: "unit($number)",
			desc: l10n.t("Returns the unit(s) associated with a number."),
		},
		{
			func: "unitless($number)",
			desc: l10n.t("Returns whether a number has units."),
		},
		{
		...
		{
			func: "call($name, $args…)",
			desc: l10n.t("Dynamically calls a Sass function."),
		},
	];
	...
	constructor(
		lsServiceOptions: LanguageServiceOptions,
	...
	public getCompletionForImportPath(
		...
		if (
			parentType === nodes.NodeType.Forward ||
			parentType === nodes.NodeType.Use
		) {
			for (let p of SCSSCompletion.scssModuleBuiltIns) {
				const item: CompletionItem = {
					...
					textEdit: TextEdit.replace(
						this.getCompletionRange(importPathNode),
						`'${p.label}'`,
					),
	...
	private createReplaceFunction() {
		...
		return (_match: string, p1: string) => {
			return (
				...
				tabStopCounter++ +
				":" +
				(SCSSCompletion.variableDefaults[p1] || "") +
				"}"
			);
		};
	}
	...
	private createFunctionProposals(
		proposals: IFunctionInfo[],
		existingNode: nodes.Node | null,
		sortToEnd: boolean,
		result: CompletionList,
	): CompletionList {
		for (const p of proposals) {
			const insertText = p.func.replace(
				/\[?(\$\w+)\]?/g,
	...
	public getCompletionForAtDirectives(
		result: CompletionList,
	): CompletionList {
	...
	public getCompletionForModuleLoaders(
		result: CompletionList,
	): CompletionList {
 ...
 */
function addReferencesToDocumentation(
	items: (CompletionItem & { references?: IReference[] })[],
) {
	items.forEach((i) => {
