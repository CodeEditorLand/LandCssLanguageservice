...
export const Rules = {
	...
	DuplicateDeclarations: new Rule(
		"duplicateProperties",
		l10n.t("Do not use duplicate style definitions"),
		Ignore,
	),
	EmptyRuleSet: new Rule(
		"emptyRules",
		l10n.t("Do not use empty rulesets"),
		Warning,
	),
	ImportStatemement: new Rule(
		"importStatement",
		l10n.t("Import statements do not load in parallel"),
		Ignore,
	),
	BewareOfBoxModelSize: new Rule(
		"boxModel",
		l10n.t("Do not use width or height when using padding or border"),
		Ignore,
	),
	UniversalSelector: new Rule(
		"universalSelector",
		l10n.t("The universal selector (*) is known to be slow"),
		Ignore,
	),
	ZeroWithUnit: new Rule(
		"zeroUnits",
		l10n.t("No unit for zero needed"),
		Ignore,
	),
	...
	ArgsInColorFunction: new Rule(
		...
		l10n.t("Invalid number of parameters"),
		Error,
	),
	UnknownProperty: new Rule(
		"unknownProperties",
		l10n.t("Unknown property."),
		Warning,
	),
	UnknownAtRules: new Rule(
		"unknownAtRules",
		l10n.t("Unknown at-rule."),
		Warning,
	),
	IEStarHack: new Rule(
		"ieHack",
		l10n.t("IE hacks are only necessary when supporting IE7 and older"),
		Ignore,
	),
	UnknownVendorSpecificProperty: new Rule(
		"unknownVendorSpecificProperties",
		l10n.t("Unknown vendor specific property."),
		Ignore,
	),
	PropertyIgnoredDueToDisplay: new Rule(
		"propertyIgnoredDueToDisplay",
		l10n.t("Property is ignored due to the display."),
		Warning,
	),
